...
void load_test_vec()
{
	...
	try {
		...
		/*cout << "happy smile sad" << endl;
		cout << "3CosAdd: " << corpus.analogy_3_cos_add("happy", "smile", "sad") << endl;
		cout << "3CosMul: " << corpus.analogy_3_cos_mul("happy", "smile", "sad") << endl;

		cout << "small big tiny" << endl;
		...
		cout << "dog pet lion" << endl;
		cout << "3CosAdd: " << corpus.analogy_3_cos_add("dog", "pet", "lion") << endl;
		cout << "3CosMul: " << corpus.analogy_3_cos_mul("dog", "pet", "lion") << endl;

		cout << "kitchen toaster livingroom" << endl;
		cout << "3CosAdd: " << corpus.analogy_3_cos_add("hungary", "budapest", "germany") << endl;
		cout << "3CosMul: " << corpus.analogy_3_cos_mul("hungary", "budapest", "germany") << endl;*/
		...
		{
			try {
			cout << "3cosMul: " << corpus.analogy_3_cos_mul(a, a_, b) << endl;
			cout << "3cosAdd: " << corpus.analogy_3_cos_add(a, a_, b) << endl << endl;
